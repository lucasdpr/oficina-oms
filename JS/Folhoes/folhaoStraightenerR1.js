...
function renderizarCangalhasR1() {
    ...
    bases.forEach(base => {
        ...
        for (let i = 1; i <= 7; i++) {
            html += `<tr><td>${i}ª</td>
                <td style="text-align:center;"><input type="radio" name="r1cang-${prefix}-${i}-a" value="OK"></td>
                <td style="text-align:center;"><input type="radio" name="r1cang-${prefix}-${i}-a" value="NOK"></td>
                <td style="text-align:center;"><input type="radio" name="r1cang-${prefix}-${i}-b" value="OK"></td>
    ...
    tipos.forEach(t => {
        ...
        t.pos.forEach(p => {
            html += `<tr><td style="text-align:center;font-weight:bold;">${p}</td>
                ...
                <td style="text-align:center;"><input type="radio" name="r1cil-${t.prefix}-${p}" value="OK"></td>
...
function renderizarInspecaoRolosR1(tipo) {
    ...
    bases.forEach(base => {
        ...
        for (let i = 1; i <= 7; i++) {
            html += `<tr><td style="text-align:center;font-weight:bold;">${i}</td>`;
            for (let j = 1; j <= 4; j++) {
                html += `<td style="text-align:center;"><input type="radio" name="r1rol-${prefix}-${bPrefix}-${i}-${j}" value="OK"></td>
        ...
        for (let i = 1; i <= 7; i++) {
            html += `<tr><td style="text-align:center;font-weight:bold;">${i}</td>`;
            for (let j = 1; j <= 4; j++) {
                html += `<td style="text-align:center;"><input type="radio" name="r1hid-${prefix}-${bPrefix}-${i}-${j}" value="OK"></td>
...
function renderizarGraxaR1() {
    ...
    bases.forEach(base => {
        ...
        for (let i = 7; i >= 1; i--) {
            html += `<tr><td style="text-align:center;font-weight:bold;">${i}</td>
                <td style="text-align:center;"><input type="radio" name="r1grx-${prefix}-${i}" value="OK"></td>
